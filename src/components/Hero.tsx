...
const Hero = () => {
  ...
  useEffect(() => {
    const setupAnimation = () => {
      ...
      function createRandomMovement(element: HTMLElement) {
      ...
      tl.from(hero, { duration: 1.2, opacity: 0, scale: 1.1 })
        .from(text.children[0], { duration: 0.8, opacity: 0, y: 50, delay: -0.8 })
        .from(text.children[1], { duration: 0.8, opacity: 0, y: 50, delay: -0.6 })
        .from(text.children[2], { duration: 0.8, opacity: 0, y: 50, delay: -0.4 })
        .to(typing, {
          duration: 2,
